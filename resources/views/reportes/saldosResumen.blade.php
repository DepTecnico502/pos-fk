...
@section('page-link')
    <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Reportes/</span> saldos pendientes de pago</h4>
@endsection

@section('content')
    <div class="card">
        <div class="card-body">
            <a href="{{ route('saldos-resumen.excel') }}" class="btn btn-success">EXCEL</a>
            <br />
            <br />
