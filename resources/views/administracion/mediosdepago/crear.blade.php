...
@section('page-link')
    <h4 class="fw-bold py-3 mb-4"><a class="text-muted fw-light" href="{{ route('configuracion.mediosdepago.index') }}">Medios de pago/</a> crear</h4>
@endsection

@section('content')
    <div class="card">
        <div class="card-header d-flex justify-content-between align-items-center">
            <h5 class="mb-0">Crear medio de pago</h5>
        </div>
        <div class="card-body">
            <div class="col-md-6">
                        ...
                        <div class="modal fade" id="exampleModalCenter" tabindex="-1" aria-hidden="true">
                            <div class="modal-dialog modal-dialog-centered" role="document">
                                <div class="modal-content">
                                    ...
                                    <h5 class="modal-title" id="modalCenterTitle">Crear medio de pago</h5>
                                    <button
                                        type="button"
                                        class="btn-close"
